param(
    ...
    [string]$NValues = "50,100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000",
...
$Runner = Join-Path $ScriptDir "progressive_model_race.py"
